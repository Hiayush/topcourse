  ...
  return (
    <div className='bg-bgDark bg-opacity-80 w-[300px] rounded-md overflow-hidden'>
        <div className='relatvie'>
            ...
            <div className='rounded-full w-[40px] bg-white absolute right-2 bottom-[-12] gride place-item-center'>
        ...
        <div className='p-4'>
            ...
            <p className='mt-2 text-white'>{props.course.description.length > 100 ? props.course.description.substring(0,100)+ "..." : props.course.description } </p>
        </div>
